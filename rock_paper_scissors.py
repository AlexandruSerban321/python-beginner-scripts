...
def rock_paper_scissors():
    ...
    user_choice = str(input(
        "Chose one of three : rock(r), paper(p), scissors(s) ( CASE SENSITIVE ) "))
    # Tie resolution
    if user_choice[0] == script_choice[0]:
        print("Is's a tie!")
    # User rock choice resolution
    if user_choice[0] == "r" and script_choice[0] == "p":
    ...
    if user_choice[0] == "s" and script_choice[0] == "r":
    ...
    if user_choice[0] == "p" and script_choice[0] == "r":
